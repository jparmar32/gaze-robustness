...
def gaze_heatmap_segmentation_iou_plots(gaze_seqs, segmentation_masks, gaze_maps, threshold, map_size):
...
def heatmap_segmentation_visual_analysis(gaze_maps, segmentation_masks, threshold, map_size):
    ...
    iou_top = iou_sorted[:20]
    iou_worst = iou_sorted[-20:]
...
def main(threshold, threshold_max = .95, interval = 0.05, map_size = 7, image_analysis=False):
    ...
    if image_analysis:
        heatmap_segmentation_visual_analysis(gaze_heatmaps, segmentation_masks, 0.1, map_size = 7)
        return 
